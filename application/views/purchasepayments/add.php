...
<form method="post" action=" <?= base_url('purchasepay/save')?>">
                ...
                <div class="col-8">
                    <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="date" class="form-control form-control-sm datepicker" placeholder="Date" value="<?= date('d-m-Y'); ?>" readonly required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="challan" class="form-control form-control-sm numbers-decimal" value="0" placeholder="Amount" required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="invoice" class="form-control form-control-sm numbers-decimal" value="0" placeholder="Amount" required>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control form-control-sm" name="desc" placeholder="Description..." rows="5"></textarea>
                        ...
                        <div class="card-footer text-right">
                            <a href="<?= base_url('purchasepay') ?>" class="btn btn-danger btn-sm">Cancel</a>
